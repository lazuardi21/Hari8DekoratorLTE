...
public class BarangController {
	...
	@RequestMapping(value = "/filterharga/", method = RequestMethod.GET)
	public ResponseEntity<Collection<Barang>> searchByHarga(@RequestParam(value = "harga") long harga, @RequestParam(value = "harga2") long harga2) {
		Collection<Barang> list = barangService.searchByHarga(harga, harga2);
