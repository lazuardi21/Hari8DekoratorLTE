...
<script>
	...
	function searchHarga() {
		var search = $('#search2').val();
		var url = '';
		if (search == '') {
			url = 'barang/'
		} else {
			url = 'barang/filterharga/?harga=' + search
		}
		$.ajax({
			type : 'get',
			url : url,
	...
	function searchHarga2() {
		var hargaAtas = $('#search3').val();
		var hargaBawah = $('#search2').val();

		$.ajax({
			type : 'get',
			url : 'barang/filterharga/?harga2=' + hargaAtas + '&harga='
					+ hargaBawah,
			success : function(d) {
				tampilkanData(d);
			},
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>Kode Barang</label> <input type="text"
										class="form-control" name="kode" id="kode">
								</div>
								<div class="form-group">
									<label>Nama Barang</label> <input type="text"
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-addon">Rp</span> <input type="number"
											class="form-control" name="harga" id="harga">
									</div>
								</div>
								<div class="form-group">
									<label>Satuan</label> <input type="text" class="form-control"
				...
				<div class="box-header">
					...
					<div class="box-tools">
						...
						<div class="input-group input-group-sm">
							<input type="text" id="search2" class="form-control pull-right"
								placeholder="Harga Min">
							<div class="input-group-btn"></div>

							<div class="input-group input-group-sm">
								<input type="text" id="search3" class="form-control pull-right"
									placeholder="Harga Max">
								<div class="input-group-btn">
									<button type="button" class="btn btn-default"
										onclick="searchHarga2()">
										<i class="fa fa-search"></i>
									</button>
								</div>
